  ...
  return (
    <section id="process" className="px-5 mx-auto flex-1 py-24 w-full bg-slate-100">
        <div className="mx-auto md:container flex flex-col gap-5 justify-center items-center">
          ...
          <h2 className="w-full md:w-1/2 text-center">Commited to give access to loans to every user in a reasonable period with transparent and effiscient applicaiton verification process.</h2>
