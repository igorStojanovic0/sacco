...
const Testimoni: React.FC<TestimoniProps> = ({
  listTestimoni = [
    ...
    },
    {
      ...
      rating: "4.5",
      testimoni:
        "Wow... I am very happy to use this platform, it turned out to be more than my expectations and so far there have been no problems. Twezimbe platform always the best",
    },
    {
      name: "iezh Robert",
      image: "/assets/people-3.png",
