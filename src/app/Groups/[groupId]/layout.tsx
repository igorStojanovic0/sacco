...
export default function GroupMainLayout({
    ...
    const { setMsgInputState } = useMyContext()
        ...
        groupUserList?.map((user: any) => {
            if ((params?.wId === '1' || params?.wId === '2') && (user?.user_id === userId)) {
                if (user?.role_name === 'GroupUser') {
                    ...
                    console.log("hihihihihii", user.role_name);
                }
                    ...
                    <div>
                        ...
                        <div className='mt-[5px] space-y-0.5'>
                            <Link
                                ...
                                className={`group relative mx-2 flex items-center rounded px-2 py-1 hover:bg-gray-500`}
                                onClick={() => setChannelTitle('Rule')}
                            >
                            ...
                            <Link
                                ...
                                className={`group relative mx-2 flex items-center rounded px-2 py-1 hover:bg-gray-500`}
                                onClick={() => setChannelTitle('Announcement')}
                            >
                                {/* {state === 'inactiveUnread' && ( */}
                                {/* <div className='absolute left-0 -ml-2 h-2 w-1 rounded-r-full bg-white'></div> */}
                                {/* )} */}
                        ...
                        <ul>
                            <li>
                                <details className="group [&_summary::-webkit-details-marker]:hidden">
                                    <summary
                                        className="flex cursor-pointer items-center justify-start rounded-lg py-2 hover:bg-gray-600"
                                    >
                                    ...
                                    <ul className=" px-2">
                                        <li>
                                            <Link href="#" className="flex rounded-lg px-4 py-2 font-medium hover:bg-gray-600">
                    ...
                    {memberProfileFlag && (
                        <div className='absolute w-1/3 right-0 bg-[#e1e4f5] h-[calc(100vh-50px)]'>
                            ...
                            <div className='justify-between w-full flex p-5 gap-3'>
                                <button
                                    onClick={() => {
                                        router.push(`/Groups/${params?.groupId}/welcome/${selectedUser?._id}`)
